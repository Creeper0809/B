...
- **타입 안정성**: 함수 포인터, nullable/non-null 포인터 구분
...
```b
func(T1, T2) -> R     // 함수 포인터 타입
func(T) -> R          // 단일 파라미터
func() -> R           // 파라미터 없음
func(T1, T2)          // 리턴 없음 (void)
```
...
func main() {
    var f: func(i64, i64) -> i64 = add;  // 함수 주소 대입
    var result = f(10, 3);                // 간접 호출
...
**테스트 현황**:
- Passing: 39 tests
- Failing: 4 tests (V4 이동 예정 기능: 20, 22, 24, 33
**구현 위치**: `src/v3_hosted/`
