...
func emit_stderr(s: i64, len: i64) -> i64 {
    sys_write(2, s, len);
}

func emit_stderr_nl() -> i64 {
    var nl;
    nl = heap_alloc(1);
    ptr8[nl] = 10;
    sys_write(2, nl, 1);
...
func check_type_compat(from_base: i64, from_depth: i64, to_base: i64, to_depth: i64) -> i64 {
...
func get_type_name(base_type: i64, ptr_depth: i64) -> i64 {
...
func get_type_size(base_type: i64, ptr_depth: i64) -> i64 {
...
func get_pointee_size(base_type: i64, ptr_depth: i64) -> i64 {
...
func vec_push(v: i64, item: i64) -> i64 {
    var len;
    len = ptr64[v + 8];
    var cap;
    cap = ptr64[v + 16];
...
func vec_set(v: i64, i: i64, val: i64) -> i64 {
    var buf;
    buf = ptr64[v];
    ptr64[buf + i * 8] = val;
}
...
func str_eq(s1: i64, len1: i64, s2: i64, len2: i64) -> i64 {
...
func str_copy(dst: i64, src: i64, len: i64) -> i64 {
    var i;
    i = 0;
    while (i < len) {
...
func str_concat(s1: i64, len1: i64, s2: i64, len2: i64) -> i64 {
    var result;
...
func str_concat3(s1: i64, len1: i64, s2: i64, len2: i64, s3: i64, len3: i64) -> i64 {
    var result;
...
func path_dirname(path: i64, path_len: i64) -> i64 {
    var last_slash;
    last_slash = 0 - 1;
    var i;
    i = 0;
...
func path_join(dir: i64, dir_len: i64, name: i64, name_len: i64) -> i64 {
    var slash;
    slash = heap_alloc(1);
    ptr8[slash] = 47;  // '/'
...
func module_to_path(name: i64, name_len: i64) -> i64 {
    var ext;
    ext = heap_alloc(2);
    ptr8[ext] = 46;      // '.'
    ptr8[ext + 1] = 98;  // 'b'
...
func fnv1a_hash(ptr: i64, len: i64) -> i64 {
    var hash;
    hash = 0;
    var i;
    i = 0;
...
func hashmap_new(capacity: i64) -> i64 {
    var cap;
    cap = 16;
    while (cap < capacity) {
        cap = cap * 2;
...
func hashmap_entry_ptr(entries: i64, idx: i64) -> i64 {
    return entries + idx * 40;
}

// Grow hashmap to double capacity
func hashmap_grow(map: i64) -> i64 {
    var old_entries;
...
func hashmap_put_internal(map: i64, key_ptr: i64, key_len: i64, value: i64) -> i64 {
    var entries;
    entries = ptr64[map];
    var cap;
    cap = ptr64[map + 8];
...
func hashmap_put(map: i64, key_ptr: i64, key_len: i64, value: i64) -> i64 {
    var entries;
    entries = ptr64[map];
    var cap;
    cap = ptr64[map + 8];
...
func hashmap_get(map: i64, key_ptr: i64, key_len: i64) -> i64 {
    var entries;
    entries = ptr64[map];
    var cap;
    cap = ptr64[map + 8];
...
func hashmap_has(map: i64, key_ptr: i64, key_len: i64) -> i64 {
    var entries;
    entries = ptr64[map];
    var cap;
    cap = ptr64[map + 8];
