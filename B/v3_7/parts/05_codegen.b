...
func symtab_add(s: i64, name_ptr: i64, name_len: i64, type_kind: i64, ptr_depth: i64) -> i64 {
    var names;
    names = ptr64[s];
    var offsets;
    offsets = ptr64[s + 8];
