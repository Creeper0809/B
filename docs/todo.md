...
- [ ] 공용 자료구조 (2단계): Vec (push-only, u64 원소)
...
- [ ] P1 스모크 테스트: heap/문자열/Vec 기본 기능 확인
...
- [ ] 조건 파서 (9단계): `&&/||` 단락평가
  ...
  - 포함: `parse_cond_emit_jfalse`, cond_atom/not/and/or

- [ ] stmt (10단계): if/while/break/continue/return + 대입/표현식 문장
  - Depends on: 조건 파서, expr.b, label_gen, emitter
  - 포함: `stmt_if`, `stmt_while`, `stmt_assign`, `stmt_break`, `stmt_continue`, `stmt_return`, `stmt_expr`

- [ ] P5 스모크 테스트: expr/조건/루프 코드젠 확인
