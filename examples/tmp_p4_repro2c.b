// scratch: repro2 but helper has no early returns
...
func is_dump_ir_arg(p) {
	...
	if (ptr8[p + 0] != 45) { ok = 0; }
	if (ptr8[p + 1] != 45) { ok = 0; }
	if (ptr8[p + 2] != 100) { ok = 0; }
	if (ptr8[p + 3] != 117) { ok = 0; }
	if (ptr8[p + 4] != 109) { ok = 0; }
	if (ptr8[p + 5] != 112) { ok = 0; }
	if (ptr8[p + 6] != 45) { ok = 0; }
	if (ptr8[p + 7] != 105) { ok = 0; }
	if (ptr8[p + 8] != 114) { ok = 0; }
	if (ptr8[p + 9] != 0) { ok = 0; }
	return ok;
}
...
func main(argc, argv) {
	...
	var is_dump = is_dump_ir_arg(path);
	if (is_dump == 1) {
		if (argc >= 3) {
			dump_ir = 1;
			path = ptr64[argv + 16];
