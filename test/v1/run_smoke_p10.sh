...
input_src="$root_dir/test/v1/smoke/p10_hex_char_asm_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/p10_driver.b"
drv_asm="$out_dir/p10_driver.asm"
drv_obj="$out_dir/p10_driver.o"
drv_bin="$out_dir/p10_driver"
