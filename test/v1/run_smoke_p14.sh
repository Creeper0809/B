...
input_src="$root_dir/test/v1/smoke/p14_const_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/p14_driver.b"
drv_asm="$out_dir/p14_driver.asm"
drv_obj="$out_dir/p14_driver.o"
drv_bin="$out_dir/p14_driver"
