...
input_src="$root_dir/test/v1/smoke/p9_ptr_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/p9_driver.b"
drv_asm="$out_dir/p9_driver.asm"
drv_obj="$out_dir/p9_driver.o"
drv_bin="$out_dir/p9_driver"
