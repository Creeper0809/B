...
input_src="$root_dir/test/v1/smoke/p11_recursion_fib_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p11_driver.b"
drv_asm="$out_dir/v2_p11_driver.asm"
drv_obj="$out_dir/v2_p11_driver.o"
drv_bin="$out_dir/v2_p11_driver"
...
echo "PASS: v2 P11 recursion fib"
