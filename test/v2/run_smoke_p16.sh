...
input_src="$root_dir/test/v2/smoke/p16_struct_fields.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p16_driver.b"
drv_asm="$out_dir/v2_p16_driver.asm"
drv_obj="$out_dir/v2_p16_driver.o"
drv_bin="$out_dir/v2_p16_driver"
...
echo "PASS: v2 P16 struct fields"
