...
input_src="$root_dir/test/v2/smoke/p17_addr_deref.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p17_driver.b"
drv_asm="$out_dir/v2_p17_driver.asm"
drv_obj="$out_dir/v2_p17_driver.o"
drv_bin="$out_dir/v2_p17_driver"
