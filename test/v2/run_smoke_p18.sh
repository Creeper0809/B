...
input_src="$root_dir/test/v2/smoke/p18_import_main.b"

out_dir="$root_dir/build"
merged="$out_dir/v2_p18_driver.b"
drv_asm="$out_dir/v2_p18_driver.asm"
drv_obj="$out_dir/v2_p18_driver.o"
drv_bin="$out_dir/v2_p18_driver"
...
echo "PASS: v2 P18 import two files"
