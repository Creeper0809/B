...
input_src="$root_dir/test/v2/smoke/p1_over6_args_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p1_over6_args_driver.b"
drv_asm="$out_dir/v2_p1_over6_args_driver.asm"
drv_obj="$out_dir/v2_p1_over6_args_driver.o"
drv_bin="$out_dir/v2_p1_over6_args_driver"
