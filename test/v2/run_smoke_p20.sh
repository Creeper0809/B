...
input_src="$root_dir/test/v2/smoke/p20_type_cast_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p20_driver.b"
drv_asm="$out_dir/v2_p20_driver.asm"
drv_obj="$out_dir/v2_p20_driver.o"
drv_bin="$out_dir/v2_p20_driver"
...
echo "PASS: v2 P20 type hint/cast"
