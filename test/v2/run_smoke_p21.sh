...
input_src="$root_dir/test/v2/smoke/p21_switch_case_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p21_driver.b"
drv_asm="$out_dir/v2_p21_driver.asm"
drv_obj="$out_dir/v2_p21_driver.o"
drv_bin="$out_dir/v2_p21_driver"
