...
input_src="$root_dir/test/v2/smoke/p22_for_foreach.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p22_driver.b"
drv_asm="$out_dir/v2_p22_driver.asm"
drv_obj="$out_dir/v2_p22_driver.o"
drv_bin="$out_dir/v2_p22_driver"
