...
input_src="$root_dir/test/v2/smoke/p24_asm_raw_input.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p24_driver.b"
drv_asm="$out_dir/v2_p24_driver.asm"
drv_obj="$out_dir/v2_p24_driver.o"
drv_bin="$out_dir/v2_p24_driver"
...
echo "PASS: v2 P24 raw asm block"
