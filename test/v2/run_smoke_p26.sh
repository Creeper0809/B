...
input_src="$root_dir/test/v2/smoke/p26_non_qword_fields.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p26_driver.b"
drv_asm="$out_dir/v2_p26_driver.asm"
drv_obj="$out_dir/v2_p26_driver.o"
drv_bin="$out_dir/v2_p26_driver"
...
echo "PASS: v2 P26 non-qword struct fields"
