...
# P27: declaration-only struct aggregate init (brace-init)
...
input_src="$root_dir/test/v2/smoke/p27_struct_init.txt"

out_dir="$root_dir/build"
merged="$out_dir/v2_p27_driver.b"
drv_asm="$out_dir/v2_p27_driver.asm"
drv_obj="$out_dir/v2_p27_driver.o"
drv_bin="$out_dir/v2_p27_driver"
...
echo "PASS: v2 P27 struct brace-init"
