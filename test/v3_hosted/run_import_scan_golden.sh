...
./bin/v2c examples/v3_hosted/p2_import_scan_smoke.b >/dev/null
DRIVER="$ROOT/build/p2_import_scan_smoke.b.v2_out_bin"

fail=0
for f in "$ROOT"/test/v3_hosted/import_scan_golden/*_entry.b; do
	base="${f%.b}"
