...
# Build v2 compiler driver (same composition as existing v2 smoke tests)
...
input_src="$root_dir/src/v3_hosted/p0_lex_main.b"

out_dir="$root_dir/build"
merged="$out_dir/v2_v3_hosted_p0_driver.b"
drv_asm="$out_dir/v2_v3_hosted_p0_driver.asm"
drv_obj="$out_dir/v2_v3_hosted_p0_driver.o"
drv_bin="$out_dir/v2_v3_hosted_p0_driver"

out_asm="$out_dir/v2_out.asm"
out_obj="$out_dir/v3_hosted_p0_lex_out.o"
out_bin="$out_dir/v3_hosted_p0_lex_out_bin"
...
# Expected checksum for src/v3_hosted/p0_lex_main.b
expected=123
...
echo "PASS: v3_hosted P0 lex (checksum=$expected)"
