...
./bin/v2c examples/v3_hosted/p3_typecheck_smoke.b >/dev/null
DRIVER="$ROOT/build/p3_typecheck_smoke.b.v2_out_bin"

fail=0
for f in "$ROOT"/test/v3_hosted/typecheck_golden/*.b; do
	base="${f%.b}"
